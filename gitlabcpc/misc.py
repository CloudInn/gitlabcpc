...
def format_seconds(seconds):
    """Gitlab estimates, spent time is returned either in seconds or in a human
    readable format, in order to performa any operations on the time estimates
    the easiest way to do it is to use the seconds, perform any operations
    and then format the resut into a readable format"""
...
def _get_working_hours(start_date, end_date, weekend_start="Sun"):
    """ Get the number of available work hours in a georgian calendar's date
    period.
    Assumptions made:
