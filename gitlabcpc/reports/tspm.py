...
class Report(BaseReport):
    ...
    def generate(self):
        ...
        data = {'total_spent': {'label': 'Total hours',
                                "Hours": {'value': 0, 'formatter': 'seconds'}},
        ...
        for issue in issues:
            ...
            if projects[issue.project_id] in data['projects']:
                ...
                data['projects'][projects[issue.project_id]] = {
                    'value': issue_spent, 'formatter': 'seconds'}
            ...
            if engineer in data['engineers']:
                val = data['engineers'][engineer]['value']
                data['engineers'][engineer]['value'] = val + issue_spent
            else:
                data['engineers'][engineer] = {'value': issue_spent,
                                               'formatter': 'seconds'}
